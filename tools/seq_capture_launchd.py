...
PASS_ENV_KEYS = (
    ...
    "SEQ_MEM_REMOTE_URL",
    "SEQ_MEM_REMOTE_DB",
    "SEQ_MEM_REMOTE_TABLE",
    "SEQ_MEM_REMOTE_USER",
    "SEQ_MEM_REMOTE_PASSWORD",
    "SEQ_MEM_REMOTE_TIMEOUT_S",
    "SEQ_MEM_REMOTE_VERIFY_TLS",
    "SEQ_MEM_REMOTE_FALLBACK_PATH",
    "SEQ_MEM_LOCAL_TAIL_ENABLED",
    ...
    "SEQ_KAR_SIGNAL_ZMODE_DECISION_TTL_MS",
